...
register_dataset("ctu-bookstore", Bookstore)
...
register_dataset("ctu-nations", Nations)
...
register_dataset("ctu-pyrimidine", Pyrimidine)
...
register_dataset("ctu-university", University)
register_dataset("ctu-utube", UTube)
